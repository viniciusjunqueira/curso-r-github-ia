...
chattr_use("gpt41-mini")  # Recomendado: rápido e econômico

# Abre o chat no painel lateral do RStudio
chattr_app(as_job = TRUE)

# Ou use o Addin: Tools > Addins > Browse Addins > "chattr"
```

```{r}
# OpenAI Models (requer OPENAI_API_KEY)
# chattr_use("gpt35")        # gpt-3.5-turbo
chattr_use("gpt41")         # gpt-4
chattr_use("gpt4o")        # gpt-4o
chattr_use("gpt41-mini")   # gpt-4o-mini

# Anthropic Models (requer ANTHROPIC_API_KEY)
# Configure o provider diretamente
chattr_defaults(
  provider = "anthropic",
